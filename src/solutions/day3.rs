...
pub fn generator(
    raw_input: &str,
) -> (Vec<(usize, usize, usize, usize)>, Vec<(usize, usize, char)>) {
...
#[aoc(day3, part1)]
pub fn solve_part1(
    readings: &(Vec<(usize, usize, usize, usize)>, Vec<(usize, usize, char)>),
) -> usize {
...
pub fn solve_part2(
    ...
    symbols
        ...
        .map(|(y, x, symbol)| {
            ...
            let relevant_numbers: Vec<usize> = numbers
                .iter()
                .filter(|(y_n, x_s, x_e, _)| {
